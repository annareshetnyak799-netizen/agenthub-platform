...
PROVIDER_ID = os.getenv("PROVIDER_ID", "mock-openai")
PROVIDER_NAME = os.getenv("PROVIDER_NAME", "mock-openai")
DEFAULT_MODEL = os.getenv("DEFAULT_MODEL", "gpt-4o-mini")
STREAM_DELAY_SECONDS = float(os.getenv("STREAM_DELAY_SECONDS", "0.15"))
BASE_LATENCY_MS = int(os.getenv("BASE_LATENCY_MS", "250"))
